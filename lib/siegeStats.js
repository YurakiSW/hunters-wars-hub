...
// 80% e non ne aveva ancora una; se una coppia è già "approved" e la
...
export async function purgePendingBelowThreshold(threshold = 0.8) {
  const keys = await redis.smembers(PROPOSAL_INDEX_KEY);
