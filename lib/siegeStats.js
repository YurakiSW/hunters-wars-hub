...
// Esportata: la riusa anche lib/guildDefenses.js per decodificare le build
// difensive, stesso identico formato dati grezzi, stessa logica.
export function decodeUnitsForDisplay(units, baseAccuracyByName) {
