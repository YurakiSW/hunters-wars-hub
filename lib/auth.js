...
// Deck Builder è un permesso orizzontale, non un ruolo che sostituisce gli
// altri: si somma a qualsiasi role (membro, reviewer...). Admin ha accesso
// pieno a Deck Build di suo, senza bisogno del flag.
export function canManageDecks(user) {
  return user?.role === "admin" || user?.isDeckBuilder === true;
}
