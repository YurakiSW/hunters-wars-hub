...
// Toglie gli accenti per confronti "alla lettera" (Irène = Irene per chi
// digita senza accento) — usato ovunque nel sito si controlli un nome
// mostro contro l'elenco, così client e server sono sempre d'accordo.
