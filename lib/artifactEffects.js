...
// ATTENZIONE — CORRETTO IL 30/07/2026: il vecchio mapping (100:HP) era
// SBAGLATO. Prova diretta: i 2 artefatti reali di Lucioxis (entrambi
// "DEF +100" negli screenshot) hanno ENTRAMBI pri_effect codice 100 nel
// replay decodificato — quindi 100 = DEF, non HP. 101/102 NON ancora
// confermati con uno screenshot reale diverso da DEF (lasciati come
// placeholder finché non arriva uno screenshot di un artefatto HP o ATK).
//
...
// entrambi gli artefatti di Lucioxis hanno pri_effect [100, 1500, 15, ...]
// e livello 15 in game, e 1500/15 = 100 = esattamente il valore mostrato.
export const ARTIFACT_MAIN_STAT_BY_ID = {
  100: "DEF",
  101: "HP", // non confermato
  102: "ATK", // non confermato
};
